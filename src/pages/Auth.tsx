...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex">
            ...
            <div className="mt-6 text-center text-sm text-muted-foreground">
              {mode === "login" && (
                <>
                  ...
                  <button onClick={() => setMode("signup")} className="text-primary hover:text-primary/80">
                    Sign up
                  </button>
                </>
              )}
              {mode === "signup" && (
                <>
                  ...
                  <button onClick={() => setMode("login")} className="text-primary hover:text-primary/80">
                    Sign in
                  </button>
                </>
              )}
      ...
      {/* Right - Visual */}
      <div className="hidden lg:flex w-1/2 bg-card border-l border-border items-center justify-center p-12">
        <div className="max-w-md">
          <div className="w-16 h-16 rounded-xl bg-primary flex items-center justify-center mb-8">
